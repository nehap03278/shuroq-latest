  ...
  return (
    <section id="home" style={{ position:"relative", minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", overflow:"hidden", background:"linear-gradient(155deg,#F4F7FC 0%,#EAF2FD 55%,#F0F6FF 100%)" }}>
      ...
      <div style={{ position:"relative", zIndex:1, textAlign:"center", padding:"120px 5vw 60px", maxWidth:1200, margin:"0 auto" }}>
        <h1 style={{ fontFamily:"'Playfair Display',serif", fontWeight:900, fontSize:"clamp(2.2rem,5vw,4rem)", color:"#1B2D4F", lineHeight:1.15, marginBottom:0 }}>{t(lang,"hero","h1a")} <span style={{ background:"linear-gradient(135deg,#F5A623 0%,#3B82C4 100%)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent", opacity:fade?1:0, transition:"opacity .35s ease", display:"inline-block" }}>{words[wi]}</span>
          <br/>{t(lang,"hero","h1b")}
        </h1>
